defmodule LiveMudWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule LiveMudWeb.PageLive do
        use LiveMudWeb, :live_view

        on_mount {LiveMudWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{LiveMudWeb.UserAuth, :ensure_authenticated}] do
